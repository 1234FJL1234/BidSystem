...
public interface IUserMapper {
	...
	// 修改用户信息
	public int update(@Param("id") int id, @Param("userName") String userName, @Param("userpwd") String userpwd,
			@Param("workUnit") String workUnit, @Param("address") String address);
